 ...
 <section id="main-content">
      <section class="wrapper">
         ...
         <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <?php
              $result = mysqli_query($conn,"SELECT * FROM sales WHERE status='' ");
              $num_rows = mysqli_num_rows($result);
              ?>
          ...
          <!--/.col-->
           ...
           <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <?php
              $result = mysqli_query($conn,"SELECT * FROM sales WHERE status='approved'");
              $num_rows = mysqli_num_rows($result);
              ?>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <?php
              ...
              <div class="count"><h1><?php echo $num_rows; ?></h1></div>
              <div class="title">Activity Earnings</div>
            </div>
            <!--/.info-box-->
          </div>
