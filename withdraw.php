...
<?php include("includes/sidebar.php");?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Make A Withdrawal</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
 ...
 <form action="make-withdraw.php" class="form-login" method="post">
      ...
      echo htmlentities($msg);
            ...
            <br>
             <input type="number" class="form-control" placeholder="Enter Amount to Withdraw" name="amount" required="required" autofocus>
                <br>
