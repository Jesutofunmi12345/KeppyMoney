...
<html lang="en">
  <head>
    ...
    <title>KeppyMoney | Homepage</title>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	   <!--<div class="row" style="margin-top: 4%">-->
        ...
        <!-- Blog Entries Column -->
        <div class="col-sm-2 col-md-4 col-lg-4 col-xs-8 left-section">
        <h2>Welcome,<span>to Keppy money</span></h2>
        <hr></hr>
        <p>We help to nurture your money till it's bigger</p>
        <button id="submit" class="btn btn-primary" href="#">Enroll</button>
        </div>
		
		<div class="col-sm-4 col-md-8 col-lg-8 col-xs-12">
	  		<div class="container">
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
    ...
    <script>
        $.backstretch("assets/img/keppy-bg.jpg", {speed: 500});
    </script>
